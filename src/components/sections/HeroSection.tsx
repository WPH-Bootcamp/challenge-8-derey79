...
export default function HeroSection() {
  ...
  return (
    <Section
      id='hero'
      className='{`min-h-screen relative w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-12  px-4 md:px-0`}'
    >
      <motion.div
        variants={containerVariants}
        initial='hidden'
        animate='visible'
        className='mx-2 pl-0 flex flex-col w-auto md:w-160 leading-16 md:absolute mt-16 md:top-24 left-60 gap-4 opacity-100 text-left'
      >
        {/* <div className=''> */}
        <motion.h1
        ...
        <motion.p
          variants={textVariants}
          className='text-lg text-main-color z-10'
        >
      ...
      <motion.div
        ...
        initial='hidden'
        animate='visible'
        className='w-full md:w-1/2 flex justify-center md:justify-end md:ml-auto'
      >
        <motion.div
          animate={{ y: [0, -12, 0] }}
