...
Nama: [Reymond - WPH 6]
Repository: [https://github.com/WPH-Bootcamp/challenge-8-derey79, Local Github : derey79/porto1st-project]
Deployment: [https://dereys-porto-project.vercel.app/]
Notes: [challenge sangat membantu memahami materi, dengan mengerjakan saya lebih bisa memahami penggunaan type, interface, mock data dan penerapan resusable komponen. saya mencoba menerapkan lazy loader, tetapi sepertinya masih ada bugs saat refresh dan juga masih ada bugs saat refresh terjadi flicker dan design juga belum 100% sesuai dengan Figma. banyak sekali learning point di challenge ini.]
